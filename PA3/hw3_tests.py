...
class TestCases(unittest.TestCase):
    ...
    def test_filter_by_state(self):
        expected = 58
        result = len(hw3.filter_by_state((full_data),'CA'))
        self.assertEqual(expected,result)
    # Part 3
    ...
    def test_education_greater_than(self):
        ...
        result = hw3.education_greater_than(reduced_data,'High School or Higher',60)
        self.assertEqual(expected,result)
    # test education_less_than

    def test_education_less_than(self):
        expected = reduced_data
        result = hw3.education_less_than(reduced_data,"Bachelor's Degree or Higher", 60)
        self.assertEqual(expected, result)
    ...
    def test_ethnicity_less_than(self):
        ...
        result = hw3.ethnicity_less_than(reduced_data, 'Hispanic or Latino', 5)
        self.assertEqual(expected, result)
    # test below_poverty_level_greater_than
    def test_below_poverty_level_greater_than(self):
        expected = [reduced_data[1]]
        result = hw3.below_poverty_level_greater_than(reduced_data,20)
        self.assertEqual(expected, result)
